...
#endif
#include "_dshow/dshow.h"
#include "_dshow/dvdmedia.h"
#include "_dshow/bdatypes.h"
...
bool videoInput::setupDevice(int deviceNumber, int w, int h){
    ...
    setAttemptCaptureSize(deviceNumber,w,h, MEDIASUBTYPE_RGB24);
    if(setup(deviceNumber))return true;
    return false;
}
...
int videoInput::getCameraPropertyFromCV(int cv_property){
    ...
    switch (cv_property) {
        ...
        case CAPTURE_PROP_PAN:
            return CameraControl_Pan;

        case CAPTURE_PROP_TILT:
            return CameraControl_Tilt;

        case CAPTURE_PROP_ROLL:
            return CameraControl_Roll;

        case CAPTURE_PROP_ZOOM:
            return CameraControl_Zoom;

        case CAPTURE_PROP_EXPOSURE:
            return CameraControl_Exposure;

        case CAPTURE_PROP_IRIS:
            return CameraControl_Iris;

        case CAPTURE_PROP_FOCUS:
