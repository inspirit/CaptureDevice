...
#define RGBY(i) { \
  static_cast<short>(1.164 * 64 * (i - 16) + 0.5), \
  static_cast<short>(1.164 * 64 * (i - 16) + 0.5), \
  static_cast<short>(1.164 * 64 * (i - 16) + 0.5), \
  0 \
}
...
#define RGBU(i) { \
  static_cast<short>(2.018 * 64 * (i - 128) + 0.5), \
  static_cast<short>(-0.391 * 64 * (i - 128) + 0.5), \
  0, \
  static_cast<short>(256 * 64 - 1) \
}

#define RGBV(i) { \
  0, \
  static_cast<short>(-0.813 * 64 * (i - 128) + 0.5), \
  static_cast<short>(1.596 * 64 * (i - 128) + 0.5), \
  0 \
}

short kCoefficientsRgbY[256 * 3][4] = {
